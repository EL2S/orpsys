document.addEventListener('DOMContentLoaded', function () {
    ...
    tableBody.addEventListener('click', function (event) {
        ...
        if (changeBtn) {
            ...
            fetch(`/bakeryproduct/${productId}/get/`)
    ...
    function deleteProduct(productId){
        modalContainer.innerHTML = `
            <div
                ...
                <div class="grid gap-4 py-4">
                    <p class="flex items-center text-sm font-medium text-primary">Êtes-vous sûr de vouloir supprimer cet article ? Cette action est irréversible.</p>
                    <div
                    data-slot="dialog-footer"
                    class="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end"
                    >
        ...
        confirmDelete.addEventListener('click', () => {
            window.location.href = `/bakeryproduct/${productId}/delete/`;
        });
    }
    ...
    let rows = allRows.filter(row => !row.textContent.includes("Aucun article trouvé."));
    ...
    function renderTable() {
        ...
        // Si 0 résultat
        if (totalRows === 0) {
            // afficher la ligne "Aucun article trouvé."
            const noDataRow = allRows.find(row => row.textContent.includes("Aucun article trouvé."));
